...
import 'button_switch_model.dart';
export 'button_switch_model.dart';

class ButtonSwitchWidget extends StatefulWidget {
  const ButtonSwitchWidget({super.key});
...
class _ButtonSwitchWidgetState extends State<ButtonSwitchWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ButtonSwitchModel());
